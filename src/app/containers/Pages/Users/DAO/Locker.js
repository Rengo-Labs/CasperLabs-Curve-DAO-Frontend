                          ...
                          <div className="py-5 px-4">
                            ...
                            <div className="row no-gutters">
                              <div className="col-12 mt-4">
                                ...
                                <VotingPowerActionables allowance={allowance} userLockedCRVBalance={userLockedCRVBalance} increaseAndDecreaseAllowanceMakeDeploy={increaseAndDecreaseAllowanceMakeDeploy} />
                              </div>
                            </div>
                          </div>
                        </Paper>
